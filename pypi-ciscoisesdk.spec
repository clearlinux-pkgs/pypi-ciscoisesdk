...
Version  : 2.2.2
Release  : 42
URL      : https://files.pythonhosted.org/packages/f1/e4/c3aaf990fd516a44a771c68e0ae3063075273781683f1edc13348ef40978/ciscoisesdk-2.2.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/f1/e4/c3aaf990fd516a44a771c68e0ae3063075273781683f1edc13348ef40978/ciscoisesdk-2.2.2.tar.gz
...
%prep
%setup -q -n ciscoisesdk-2.2.2
cd %{_builddir}/ciscoisesdk-2.2.2
pushd ..
cp -a ciscoisesdk-2.2.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721144156
