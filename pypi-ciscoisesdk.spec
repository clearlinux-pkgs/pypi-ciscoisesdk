...
Version  : 1.5.0
Release  : 7
URL      : https://files.pythonhosted.org/packages/16/3b/8b802d4ac2c15ed33fbed9d016175c53e28ebb65f4495a214afa9849350f/ciscoisesdk-1.5.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/16/3b/8b802d4ac2c15ed33fbed9d016175c53e28ebb65f4495a214afa9849350f/ciscoisesdk-1.5.0.tar.gz
...
%prep
%setup -q -n ciscoisesdk-1.5.0
cd %{_builddir}/ciscoisesdk-1.5.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645659376
...
cp %{_builddir}/ciscoisesdk-1.5.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-ciscoisesdk/9901a51ee03eb167026e7a7a6f20ea2473b39328
