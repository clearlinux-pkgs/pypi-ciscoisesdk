...
Version  : 1.3.1
Release  : 3
URL      : https://files.pythonhosted.org/packages/05/56/1243ccd4a23f74bbc7656532220396eed87ccbc0b457a7ed96030118c5cb/ciscoisesdk-1.3.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/05/56/1243ccd4a23f74bbc7656532220396eed87ccbc0b457a7ed96030118c5cb/ciscoisesdk-1.3.1.tar.gz
...
%prep
%setup -q -n ciscoisesdk-1.3.1
cd %{_builddir}/ciscoisesdk-1.3.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642003979
...
cp %{_builddir}/ciscoisesdk-1.3.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-ciscoisesdk/9901a51ee03eb167026e7a7a6f20ea2473b39328
