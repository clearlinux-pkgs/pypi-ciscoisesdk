...
Version  : 1.4.2
Release  : 6
URL      : https://files.pythonhosted.org/packages/f4/07/98930fa0cbedf3777321ea2b55a0b544d3fa211fa924dd1ac09b31ee5b52/ciscoisesdk-1.4.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/f4/07/98930fa0cbedf3777321ea2b55a0b544d3fa211fa924dd1ac09b31ee5b52/ciscoisesdk-1.4.2.tar.gz
...
%prep
%setup -q -n ciscoisesdk-1.4.2
cd %{_builddir}/ciscoisesdk-1.4.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645212029
...
cp %{_builddir}/ciscoisesdk-1.4.2/LICENSE %{buildroot}/usr/share/package-licenses/pypi-ciscoisesdk/9901a51ee03eb167026e7a7a6f20ea2473b39328
