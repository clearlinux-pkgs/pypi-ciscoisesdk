...
Version  : 2.0.2
Release  : 12
URL      : https://files.pythonhosted.org/packages/a6/81/3403f5cb5af2d340080768f08caf494f8512a628018d52dc668b1d4f7c94/ciscoisesdk-2.0.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/a6/81/3403f5cb5af2d340080768f08caf494f8512a628018d52dc668b1d4f7c94/ciscoisesdk-2.0.2.tar.gz
...
%prep
%setup -q -n ciscoisesdk-2.0.2
cd %{_builddir}/ciscoisesdk-2.0.2
pushd ..
cp -a ciscoisesdk-2.0.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653009184
...
cp %{_builddir}/ciscoisesdk-2.0.2/LICENSE %{buildroot}/usr/share/package-licenses/pypi-ciscoisesdk/9901a51ee03eb167026e7a7a6f20ea2473b39328
