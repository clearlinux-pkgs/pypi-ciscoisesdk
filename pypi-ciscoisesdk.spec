...
Version  : 1.4.0
Release  : 4
URL      : https://files.pythonhosted.org/packages/f9/44/1001b19bbc5f6957becff5d5b727515bb75f026123a5eb37153530a3311d/ciscoisesdk-1.4.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/f9/44/1001b19bbc5f6957becff5d5b727515bb75f026123a5eb37153530a3311d/ciscoisesdk-1.4.0.tar.gz
...
%prep
%setup -q -n ciscoisesdk-1.4.0
cd %{_builddir}/ciscoisesdk-1.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642697491
...
cp %{_builddir}/ciscoisesdk-1.4.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-ciscoisesdk/9901a51ee03eb167026e7a7a6f20ea2473b39328
