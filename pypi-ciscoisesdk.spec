...
%prep
%setup -q -n ciscoisesdk-2.0.4
cd %{_builddir}/ciscoisesdk-2.0.4
pushd ..
cp -a ciscoisesdk-2.0.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657637366
...
cp %{_builddir}/ciscoisesdk-2.0.4/LICENSE %{buildroot}/usr/share/package-licenses/pypi-ciscoisesdk/9901a51ee03eb167026e7a7a6f20ea2473b39328
