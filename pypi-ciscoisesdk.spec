...
Version  : 2.0.7
Release  : 26
URL      : https://files.pythonhosted.org/packages/99/b7/d3248bda9a0442db1e5b379a558bbe86b40e8f6beed74e71ae49d9fe6049/ciscoisesdk-2.0.7.tar.gz
Source0  : https://files.pythonhosted.org/packages/99/b7/d3248bda9a0442db1e5b379a558bbe86b40e8f6beed74e71ae49d9fe6049/ciscoisesdk-2.0.7.tar.gz
...
%prep
%setup -q -n ciscoisesdk-2.0.7
cd %{_builddir}/ciscoisesdk-2.0.7
pushd ..
cp -a ciscoisesdk-2.0.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667398524
