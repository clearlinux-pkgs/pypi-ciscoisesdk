...
Version  : 2.2.1
Release  : 41
URL      : https://files.pythonhosted.org/packages/4e/dc/b37916df02fbda2c9f5a8c072aac5dd690b944264f73f87ff1aa06b148a8/ciscoisesdk-2.2.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/4e/dc/b37916df02fbda2c9f5a8c072aac5dd690b944264f73f87ff1aa06b148a8/ciscoisesdk-2.2.1.tar.gz
...
%prep
%setup -q -n ciscoisesdk-2.2.1
cd %{_builddir}/ciscoisesdk-2.2.1
pushd ..
cp -a ciscoisesdk-2.2.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715872737
